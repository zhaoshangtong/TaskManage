...
public class Util
{
    ...
    public async static Task<string> MethodPOSTAsync(string URL, string strPostdata, string strEncoding = "UTF-8", string contentType = "application/x-www-form-urlencoded")
    {
        ...
        //RaysCloud.Common.LogHelper.Info("MethodPOSTAsync：" + strPostdata);
        ...
        //{
        //    RaysCloud.Common.LogHelper.Info("stream.Length before：" + stream.Length);
        //    await stream.WriteAsync(buffer, 0, buffer.Length);
        //    RaysCloud.Common.LogHelper.Info("stream.Length after：" + stream.Length);
        //}
